...
export const WorkingWithMe = () => (
  <>
    <h2 style={{ paddingTop: 20 }}>What it's like to work with me</h2>
    <div style={{ display: "flex", flexDirection: "column" }}>
      <p>
        "Kai is the epitome of a team player. They have an ease of personality
        ...
        a safe and inclusive atmosphere for all. Kai leads by inspiring others to
        ...
        Kai will have a myriad of creative and thoughtful solutions. It was an
        honor and a pleasure to work with Kai, and I can say with absolute
      ...
      <p>
        "Working with Kai is so wonderful because they bring so many things to an
        ...
        Kai - most outstanding is what it means to jump into something you don't
        know, and to figure out how to achieve it. Anything that is given to Kai,
        they tackle. They are someone I can depend on, someone I can trust. Kai is
        also so fun to work with. All of this together makes Kai an amazing person
      ...
      <p>
        "In my 10+ years of working at Addgene, Kai was easily one of the
        sharpest, hardest working employees with whom I've worked. Most
        employees are either "big picture" people or "detail oriented", but Kai
